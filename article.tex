...
\title{\textit{STOCHASTISCHE} RECHENÜBUNGEN}

% \section* ist ein "Themengebiet"
% \subsection* ist eine Aufgabe in einem Themengebiet
% \subsubsection* ist ein Lösungsschritt zu einer Aufgabe

% Nachdem man Dokument gearbeitet hat:
%   1. In Overleaf links auf "integrations" klicken
%   2. Auf "GitHub" klicken.
%   3. Falls "recent commits" in Github erscheint: auf "Pull Github Changes into Overleaf" klicken
%   4. Dann auf Push Overleaf changes to github
%   5. kurz die Änderungen beschreiben und dann auf "sync" klicken
%   6. Nach ein paar Minuten sollten die Änderungen sichtbar sein auf
%       https://raeichho.github.io/stochastics_exercise_website
