...
\begin{document} % All begin commands must be paired with an end command somewhere
    ...
    \textit{Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore.}
    ...
    Definiere Ereignisse $A = \{\text{Ergebnis ist mindestens 5}\}$ , $B = \{\text{Ergebnis ist höchstens 7}\}$ , $C = \{\text{Ergebnis ist ungerade}\}$.
